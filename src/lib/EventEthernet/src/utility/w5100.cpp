...
#if defined(W5100S_MODULE) || defined(W5500_MODULE)
#include "./w5100.h"
...
uint8_t W5100Class::init(void)
{
	...
	rtos::ThisThread::sleep_for(560ms);
...
uint16_t W5100Class::write(uint16_t addr, const uint8_t *buf, uint16_t len)
{
	...
	{ // chip == 61
		...
		if (addr < CH_BASE())
		{
			...
			cmd[0] = (addr >> 8) & 0x7F;
			cmd[1] = addr & 0xFF;
			cmd[2] = W6100_SPI_FRAME_CTL_BSB_BLK(0) | W6100_SPI_FRAME_CTL_BSB_COMM | W6100_SPI_FRAME_CTL_WD | W6100_SPI_FRAME_CTL_OPM_VDM;
		}
		else if (addr < W6100_TX_BASE_ADDR)
		{
			...
			cmd[0] = (addr >> 8) & 0x3;
			cmd[1] = addr & 0xFF;
			cmd[2] = W6100_SPI_FRAME_CTL_BSB_BLK((addr >> 10) & 0x7) | W6100_SPI_FRAME_CTL_BSB_SOCK | W6100_SPI_FRAME_CTL_WD | W6100_SPI_FRAME_CTL_OPM_VDM;
		}
...
uint16_t W5100Class::read(uint16_t addr, uint8_t *buf, uint16_t len)
{
	...
	{ // chip == 61
		...
		if (addr < CH_BASE())
		{
			...
			cmd[0] = (addr >> 8) & 0x7F;
			cmd[1] = addr & 0xFF;
			cmd[2] = W6100_SPI_FRAME_CTL_BSB_BLK(0) | W6100_SPI_FRAME_CTL_BSB_COMM | W6100_SPI_FRAME_CTL_RD | W6100_SPI_FRAME_CTL_OPM_VDM;
		}
		else if (addr < W6100_TX_BASE_ADDR)
		{
			// socket registers
			...
			cmd[0] = (addr >> 8) & 0x3;
			cmd[1] = addr & 0xFF;
			cmd[2] = W6100_SPI_FRAME_CTL_BSB_BLK((addr >> 10) & 0x7) | W6100_SPI_FRAME_CTL_BSB_SOCK | W6100_SPI_FRAME_CTL_RD | W6100_SPI_FRAME_CTL_OPM_VDM;
		}
		else if (addr < W6100_RX_BASE_ADDR)
		{
			// transmit buffers
			...
			cmd[2] |= W6100_SPI_FRAME_CTL_BSB_BLK(0) | W6100_SPI_FRAME_CTL_BSB_TXBF | W6100_SPI_FRAME_CTL_RD | W6100_SPI_FRAME_CTL_OPM_VDM;
		}
		else
		{
			// receive buffers
			...
			cmd[2] |= W6100_SPI_FRAME_CTL_BSB_BLK(0) | W6100_SPI_FRAME_CTL_BSB_RXBF | W6100_SPI_FRAME_CTL_RD | W6100_SPI_FRAME_CTL_OPM_VDM;
		}
		SPI.transfer(cmd, 3);
		memset(buf, 0, len);
		SPI.transfer(buf, len);
...
#endif // W5100S_MODULE || W5500_MODULE