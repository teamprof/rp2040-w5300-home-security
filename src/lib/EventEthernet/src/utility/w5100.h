...
public:
  ...
  __GP_REGISTER8(IR2_W5100S, 0x0020, 0x0000);  // Interrupt Register 2
  __GP_REGISTER8(IMR2_W5100S, 0x0021, 0x0000); // Interrupt Mask Register 2
  ...
  __GP_REGISTER8(MR2_W5100S, 0x0030, 0x0000); // Mode Register 2
  ...
  __GP_REGISTER8(SLIMR_W5100S, 0x005E, 0x0000); // SOCKET-less Interrupt Mask Register
  __GP_REGISTER8(SLIR_W5100S, 0x005F, 0x0000);  // SOCKET-less Interrupt Register
...
public:
  ...
  __SOCKET_REGISTER8(SnIMR_W5100S, 0x002C, 0x0000) // SOCKET n Interrupt Mask Register
