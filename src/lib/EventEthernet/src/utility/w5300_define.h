...
#define getSHAR(shar)                                    \
   {                                                     \
      uint16_t value = WIZCHIP_READ(SHAR);               \
      (shar)[0] = (uint8_t)(value >> 8);                 \
      (shar)[1] = (uint8_t)(value);                      \
      value = WIZCHIP_READ(WIZCHIP_OFFSET_INC(SHAR, 2)); \
      (shar)[2] = (uint8_t)(value >> 8);                 \
      (shar)[3] = (uint8_t)(value);                      \
      value = WIZCHIP_READ(WIZCHIP_OFFSET_INC(SHAR, 4)); \
      (shar)[4] = (uint8_t)(value >> 8);                 \
      (shar)[5] = (uint8_t)(value);                      \
   }
   // #define  getSHAR(shar) { \
...
#define getGAR(gar)                                     \
   {                                                    \
      uint16_t value = WIZCHIP_READ(GAR);               \
      (gar)[0] = (uint8_t)(value >> 8);                 \
      (gar)[1] = (uint8_t)(value);                      \
      value = WIZCHIP_READ(WIZCHIP_OFFSET_INC(GAR, 2)); \
      (gar)[2] = (uint8_t)(value >> 8);                 \
      (gar)[3] = (uint8_t)(value);                      \
   }
   // #define  getGAR(gar) { \
...
#define getSUBR(subr)                                    \
   {                                                     \
      uint16_t value = WIZCHIP_READ(SUBR);               \
      (subr)[0] = (uint8_t)(value >> 8);                 \
      (subr)[1] = (uint8_t)(value);                      \
      value = WIZCHIP_READ(WIZCHIP_OFFSET_INC(SUBR, 2)); \
      (subr)[2] = (uint8_t)(value >> 8);                 \
      (subr)[3] = (uint8_t)(value);                      \
   }
   // #define  getSUBR(subr) { \
...
#define getSIPR(sipr)                                    \
   {                                                     \
      uint16_t value = WIZCHIP_READ(SIPR);               \
      (sipr)[0] = (uint8_t)(value >> 8);                 \
      (sipr)[1] = (uint8_t)(value);                      \
      value = WIZCHIP_READ(WIZCHIP_OFFSET_INC(SIPR, 2)); \
      (sipr)[2] = (uint8_t)(value >> 8);                 \
      (sipr)[3] = (uint8_t)(value);                      \
   }
   // #define  getSIPR(sipr) { \
...
#define getPDHAR(pdhar)                                   \
   {                                                      \
      uint16_t value = WIZCHIP_READ(PDHAR);               \
      (pdhar)[0] = (uint8_t)(value >> 8);                 \
      (pdhar)[1] = (uint8_t)(value);                      \
      value = WIZCHIP_READ(WIZCHIP_OFFSET_INC(PDHAR, 2)); \
      (pdhar)[2] = (uint8_t)(value >> 8);                 \
      (pdhar)[3] = (uint8_t)(value);                      \
      value = WIZCHIP_READ(WIZCHIP_OFFSET_INC(PDHAR, 4)); \
      (pdhar)[4] = (uint8_t)(value >> 8);                 \
      (pdhar)[5] = (uint8_t)(value);                      \
   }
   // #define getPDHAR(pdhar) { \
...
#define getUIPR(uipr)                                    \
   {                                                     \
      uint16_t value = WIZCHIP_READ(UIPR);               \
      (uipr)[0] = (uint8_t)(value >> 8);                 \
      (uipr)[1] = (uint8_t)(value);                      \
      value = WIZCHIP_READ(WIZCHIP_OFFSET_INC(UIPR, 2)); \
      (uipr)[2] = (uint8_t)(value >> 8);                 \
      (uipr)[3] = (uint8_t)(value);                      \
   }
   // #define getUIPR(uipr) { \
